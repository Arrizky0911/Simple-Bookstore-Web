...
<body>
    ...
    <div class="float-end mb-3 me-3 mt-3">
        <a class="btn btn-success" href="languageForm.php">Add New Data</a>
    </div>
    ...
    <div class="container-fluid mt-3 text-center" style="margin-bottom: 100px;">
        ...
        <?php
         if (isset($_POST['searchSubmit']) && $_POST['search'] != "") {
            $langs = $db->getLanguagesByKey($_POST['search']);
        } else {
            $langs = $db->getAllLanguages();
        } 
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-danger" href="deleteLanguage.php?id=<?= $row['language_id']; ?>">Delete</a>
            </td>
        </tr>
        <?php
        }
